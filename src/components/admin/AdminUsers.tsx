...
import { Shield, ShieldOff, Trash2, Users, UserPlus, ShieldCheck, Search, Loader2 } from 'lucide-react';
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          title={isSelf ? 'Du kan ikke ændre din egen rolle' : undefined}
                        >
                        ...
                        <Button
                          ...
                          title={isSelf ? 'Du kan ikke slette dig selv' : 'Slet bruger'}
                        >
