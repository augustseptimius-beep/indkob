...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Bekræft din email – Klitmøllers Indkøbsfællesskab',
  invite: 'Du er inviteret til Klitmøllers Indkøbsfællesskab',
  magiclink: 'Dit login-link – Klitmøllers Indkøbsfællesskab',
  recovery: 'Nulstil din adgangskode – Klitmøllers Indkøbsfællesskab',
  email_change: 'Bekræft din nye email – Klitmøllers Indkøbsfællesskab',
  reauthentication: 'Din bekræftelseskode – Klitmøllers Indkøbsfællesskab',
}
...
// Configuration
const SITE_NAME = "indkob"
const SENDER_DOMAIN = "notify.klitkob.dk"
const ROOT_DOMAIN = "klitkob.dk"
const FROM_DOMAIN = "klitkob.dk" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://indkob.lovable.app"
